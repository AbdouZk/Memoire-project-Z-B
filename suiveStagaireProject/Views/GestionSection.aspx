               ...
               //tratement
                    ...
                    {%>
                          ...
                          <!-- Submit button -->
                           ...
                           <asp:Button ID="btnAjouterCat" CssClass="btn btn-primary btn-block mb-4" runat="server" Text="Ajouter" OnClick="btnAjouterCat_Click" /> <a href="GestionSection.aspx?id=<%=Session["id"]%>&do=" class="btn btn-secondary btn-block mb-4">Annuler</a>
                    ...
                    {%>
                        ...
                        <!-- Braches input -->
                          ...
                          <!-- Submit button -->
                           ...
                           <asp:Button ID="btnSaveEditCat" CssClass="btn btn-primary btn-block mb-4" runat="server" Text="Save" OnClick="btnSaveEditCat_Click" /> <a href="GestionSection.aspx?id=<%=Session["id"]%>&do=" class="btn btn-secondary btn-block mb-4">Annuler</a>
                    ...
                    %> <div class='alert alert-danger' role='alert'>
                                ...
                                <a href="GestionSection.aspx?id=<%=Session["id"]%>&do=" class="btn btn-secondary"> Annuler</a>
                            ...
                            {%>
                                <tr>
                                  ...
                                  <td >
                                      ...
                                      <a class="btn btn-primary " href="GestionSection.aspx?id=<%=Session["id"]%>&do=add&idCat=<%=c.idCataloge%>">Ajouter</a>
                                      <!-- Editer -->

                                      <a class="btn btn-warning " href="GestionSection.aspx?id=<%=Session["id"]%>&do=edit&idCat=<%=c.idCataloge%>">Editer</a>
                                      
                                      <!-- Supprimer -->                                    
                                      <a class="btn btn-danger m-2" href="GestionSection.aspx?id=<%=Session["id"]%>&do=delete&idCat=<%=c.idCataloge%>">Supprimer</a>
